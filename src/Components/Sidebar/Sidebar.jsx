    ...
    <div className="sidebar-container">
      ...
      <div className="sidebar-main">
        {sidebarItems.map((items, index) => (
          ...
          >
            <aside>
              <div className="sidevar-items-aside1">
              ...
              {activeItems === items.name && toggleNavItems && items.purchaseToggle && (
                <div className="nested-items-container" onClick={(e) => e.stopPropagation()} >
                 {activeItems && items.purchaseToggle.map((nestedItems, nestedindex) => (
                    <aside key={nestedindex} onClick={() => {handleActiveNestedItems(nestedindex); navigate(nestedItems.navigateurl)}} className={`sidevar-nested-items ${
                        activeNestedItems == nestedindex && "active-nav-border"
                      }`}>
